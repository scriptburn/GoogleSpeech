...
return [
    ...
    */
    ...
    'project_name' => 'Google Speech',

    // Menu logos
    'logo_lg'   => 'GoogleSpeech <sub style="font-size: 10px;cursor:pointer" id="keyman_version_info">' .KEYMAN_VERSION . "</sub>",
    'logo_mini' => '<b>I</b>o',

    // Developer or company name. Shown in footer.
    'developer_name' => 'Scriptburn' ,

    // Developer website. Link in footer.
    'developer_link' => 'http://scriptburn.com',
